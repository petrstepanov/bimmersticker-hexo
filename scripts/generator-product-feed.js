...
hexo.extend.generator.register('google-feed-generator', function (locals) {
    ...
    const increasePriceAndTweakTitleFromColorAndPatternVariations = hexo.extend.helper.get('increasePriceAndTweakTitleFromColorAndPatternVariations').bind(hexo);
    ...
    feedArray.forEach(element => {
//        increasePriceAndTweakTitleFromColorAndPatternVariations(element);
